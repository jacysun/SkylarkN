        	...
        	<tr><div class="row">
        	  <div class="col-sm-3">
        	    <table width="100%" id="price">
                  ...
                  <tr><td width="100%" align="left" valign="middle"><span>Duration:<%=il.get(i).getDuration() %>min</span></td></tr>
                </table>
        	  </div>
        	  <div class="col-sm-9">
        	    <table width="100%" id="flight">
        	    <% for (int j = 0; j < il.get(i).getFlights().size(); j++) { %>
                  ...
                  <tr><td width="50%" align="right" valign="middle"><span><%=il.get(i).getFlights().get(j).getDepartTime() %><%=il.get(i).getFlights().get(j).getDepartCode() %></span></td>
                      <td width="50%" align="left" valign="middle"><span>---><%=il.get(i).getFlights().get(j).getArrivalTime() %><%=il.get(i).getFlights().get(j).getArrivalCode() %></span></td></tr>
                <% } %>
                </table>
        	  </div>
        	</div><hr></tr>
